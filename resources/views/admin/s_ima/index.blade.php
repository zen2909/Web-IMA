...
<div class="container mx-auto mt-5">
    <div class="w-full border shadow-lg rounded-lg p-6 bg-white dark:bg-gray-800">
        <h2 class="text-2xl font-semibold mb-4 text-gray-800 dark:text-gray-200">Section Sejarah Ikatan Mahasiswa Arosbaya</h2>
        <form action="{{ route('admin.imaupdate') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('put')
            ...
            <div class="flex gap-4">
                <div class="flex flex-col w-full md:w-1/3">
                    ...
                    <img src="{{ asset('storage/' . $ima->image1) }}" class="w-full h-80 object-cover mb-4 rounded-lg shadow-md" alt="Image 1">
                ...
                <div class="flex flex-col w-full md:w-1/3">
                    ...
                    <img src="{{ asset('storage/' . $ima->image2) }}" class="w-full h-80 object-cover mb-4 rounded-lg shadow-md" alt="Image 2">
                ...
                <div class="flex flex-col w-full md:w-1/3">
                    ...
                    <img src="{{ asset('storage/' . $ima->image3) }}" class="w-full h-80 object-cover mb-4 rounded-lg shadow-md" alt="Image 3">
            ...
            <div class="mb-3">
                <textarea id="text" name="text" class="form-control mb-4 border border-gray-300 rounded-lg p-3 w-full h-32 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500" rows="5">{{ old('text', $ima->text) }}</textarea>
            </div>
