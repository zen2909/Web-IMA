    ...
    <div class="max-w-7xl mx-auto p-6 relative z-10 flex items-center justify-between h-full">
        ...
        <div class="w-full sm:w-1/2 text-white space-y-6 pr-5">
            <h1 class="text-4xl md:text-4xl lg:text-6xl font-bold text-green-700 mb-4">
                Sejarah
                <span class="block mt-2">Ikatan Mahasiswa Arosbaya</span>
            </h1>
            <p class="text-black text-lg">
                IMA : Alombhar Ta' Adhina Asal
            </p>
            @php
            // Membagi teks berdasarkan titik dengan batas pemisahan pada titik ke-3
            $paragraphs = preg_split('/\./', $ima->text, 4); // 4 bagian: 3 paragraf + sisanya
            @endphp
        ...
        <div class="grid grid-cols-2 grid-rows-2 gap-4">
            ...
            <div class="flex justify-center items-center row-span-2">
                <img class="w-full h-48 object-cover rounded-xl" src="{{ asset('storage/' . $ima->image1) }}" alt="Image 1">
            </div>

            <!-- Gambar kedua -->
            <div class="col-span-1">
                <img class="w-full h-48 object-cover rounded-xl" src="{{ asset('storage/' . $ima->image2) }}" alt="Image 2">
            </div>

            <!-- Gambar ketiga -->
            <div class="col-span-1">
                <img class="w-full h-48 object-cover rounded-xl" src="{{ asset('storage/' . $ima->image3) }}" alt="Image 3">
            </div>
        </div>
